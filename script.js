// Function to dynamically create floating background elements
function createFloatingHearts() {
    ...
    setInterval(() => {
        ...
        heart.innerText = loveSymbols[Math.floor(Math.random() * loveSymbols.length)];
        ...
        // Randomize speed
        const duration = Math.random() * 5 + 6; // 6 to 11 seconds
    ...
    }, 400); // Generates a new piece every 400ms
}
...
document.addEventListener('DOMContentLoaded', () => {
    // Fire up the continuous love theme background engine
